...
public final class FeatureFlags {
  ...
  /** Whether or not profile sharing for all is enabled */
  public static boolean profileSharingForAll() {
    return messageRequests() && getBoolean(PROFILE_SHARING_FOR_ALL, false);
  }
