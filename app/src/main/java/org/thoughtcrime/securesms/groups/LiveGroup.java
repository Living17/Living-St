...
public final class LiveGroup {
  ...
  private static final Comparator<GroupMemberEntry.FullMember>         ALPHABETICAL = (m1, m2) -> m1.getMember().toShortString(ApplicationDependencies.getApplication()).compareTo(m2.getMember().toShortString(ApplicationDependencies.getApplication()));
