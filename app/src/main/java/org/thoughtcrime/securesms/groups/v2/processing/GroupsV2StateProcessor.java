  ...
  public final class StateProcessorForGroup {
        ...
        throws IOException, GroupNotAMemberException
    {
      ...
      if (newLocalState == null || newLocalState == inputGroupState.getLocalState()) {
        ...
        updateLocalDatabaseAndInsertUpdateMessages(timestamp, inputGroupState, advanceGroupStateResult, newLocalState);
      }
    ...
    private void updateLocalDatabaseAndInsertUpdateMessages(long timestamp,
                                                            @NonNull GlobalGroupState inputGroupState,
                                                            @NonNull AdvanceGroupStateResult advanceGroupStateResult,
