...
public class ManageGroupViewModel extends ViewModel {
  ...
  void removeMember(@NonNull GroupMemberEntry.FullMember fullMember) {
    new AlertDialog.Builder(context)
                   .setMessage(context.getString(R.string.ManageGroupActivity_remove_s_from_s, fullMember.getMember().toShortString(context), title.getValue()))
                   .setPositiveButton(R.string.ManageGroupActivity_remove,
                                      (dialog, which) -> manageGroupRepository.removeMember(fullMember, this::groupStateLoaded))
