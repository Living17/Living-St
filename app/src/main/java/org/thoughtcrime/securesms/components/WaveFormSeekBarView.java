...
public final class WaveFormSeekBarView extends AppCompatSeekBar {
  ...
  private void drawWave(Canvas canvas) {
    int barWidth = getResources().getDimensionPixelSize(R.dimen.wave_form_bar_width);
    ...
    for (int bar = 0; bar < data.length; bar++) {
      ...
      paint.setColor(progress * getMax() < getProgress() ? 0xff6191F3 : 0xffB9B9B9); // ultramarine  : grey25
