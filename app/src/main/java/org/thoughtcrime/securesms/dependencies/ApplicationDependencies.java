...
import org.thoughtcrime.securesms.groups.v2.NetworkGroupStateProviderOld;
...
public class ApplicationDependencies {
  ...
  public static synchronized @NonNull GroupsV2Authorization getGroupsV2Authorization() {
    ...
    if (groupsV2Authorization == null) {
      groupsV2Authorization = new GroupsV2Authorization(getSignalServiceAccountManager().getGroupsV2Api(), new GroupsV2AuthorizationMemoryValueCache());
    }
  ...
  public static synchronized @NonNull GroupMemoryCache getGroupsV2MemoryCache() {
    ...
    if (groupMemoryCache == null) {
      ...
      groupMemoryCache = new GroupMemoryCache(new NetworkGroupStateProviderOld(groups, GroupsV2Authorization));
    }
